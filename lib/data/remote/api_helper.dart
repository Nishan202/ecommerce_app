...
class ApiHelper {
  ...
  Future<dynamic> postApi({required String url, Map<String, dynamic>? bodyParams, bool isHeaderRequired = true, Map<String, String>? mHeaders}) async {
    var uri = Uri.parse(url);
    ...
    try{
      http.Response response = await http.post(uri, headers: mHeaders, body: bodyParams != null ? jsonEncode(bodyParams) : null);
      return returnJsonResponse(response);
    } on SocketException catch(e){
      throw(FetchDataException(errorMessage: "No internet!!"));
    }
